...
const upcoming = [
  {
    label: "জাতীয় বিজ্ঞান অলিম্পিয়াড নিবন্ধন",
    date: "১৫ মার্চ",
    eventIdx: 0,
  },
      ...
      <div className="container">
        ...
        >
          ...
          >
            ...
            {/* Content */}
            <div
              style={{ padding: "28px 32px", position: "relative", zIndex: 2 }}
            >
              <div
                style={{
              ...
              {upcoming.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    onClick={() =>
                      item.eventIdx !== null && handleSelect(item.eventIdx)
                    }
                    style={{
                      display: "flex",
                      alignItems: "center",
